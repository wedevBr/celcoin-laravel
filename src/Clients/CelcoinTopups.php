...
{
    public const GET_PROVIDERS_ENDPOINT = '/v5/transactions/topups/providers';

    public const GET_PROVIDER_VALUES_ENDPOINT = '/v5/transactions/topups/provider-values';

    public const CREATE_ENDPOINT = '/v5/transactions/topups';

    public const CONFIRM_ENDPOINT = '/v5/transactions/topups/%d/capture';

    public const CANCEL_ENDPOINT = '/v5/transactions/topups/%d/void';

    public const FIND_PROVIDERS_ENDPOINT = '/v5/transactions/topups/find-providers';
