...
{
    public const GET_PARTNERS_ENDPOINT = '/v5/transactions/electronictransactions/consult-partners';

    public const GET_SERVICES_POINTS_ENDPOINT = '/v5/transactions/electronictransactions/consult-servicespoints';

    public const DEPOSIT_ENDPOINT = '/v5/transactions/electronictransactions/electronic-payment';

    public const WITHDRAW_ENDPOINT = '/v5/transactions/electronictransactions/electronic-receipt';

    public const GENERATE_WITHDRAW_TOKEN_ENDPOINT = '/v5/transactions/electronictransactions/withdraw-thirdparty';
